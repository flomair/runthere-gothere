...
export const ROUTES: Record<string, () => Promise<RouteModule>> = {
  ...
  'admin/users': () => import('../routes/admin/users.js'),
  'ai-key': () => import('../routes/ai-key.js'),
  bookmarks: () => import('../routes/bookmarks.js'),
  coach: () => import('../routes/coach.js'),
  'cron/sync': () => import('../routes/cron/sync.js'),
  elevation: () => import('../routes/elevation.js'),
  geocode: () => import('../routes/geocode.js'),
  groups: () => import('../routes/groups.js'),
  'groups/comment': () => import('../routes/groups/comment.js'),
  'groups/feed': () => import('../routes/groups/feed.js'),
  'groups/invite': () => import('../routes/groups/invite.js'),
  'groups/join': () => import('../routes/groups/join.js'),
  'groups/kudos': () => import('../routes/groups/kudos.js'),
  'groups/leave': () => import('../routes/groups/leave.js'),
  'groups/standings': () => import('../routes/groups/standings.js'),
  ...
  shares: () => import('../routes/shares.js'),
